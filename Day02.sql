...
Icinde “id”, “isim”, “maas”, “ise_baslama” field’lari olsun. “id” yi 
Primary Key yapin, “isim” i Unique, “maas” i Not Null yapın.
...
INSERT INTO calisanlar VALUES('10009', 'cem', '', '2018-04-14'); --int
...
--calisanlar tablosundan maasi 5 bin den buyuk olan isimleri listeleyiniz
SELECT isim,maas FROM calisanlar WHERE maas>5000;	

--calisanlar tablosundan ismi "veli han" olan tum veriyi listeleyiniz
SELECT * FROM calisanlar WHERE isim= 'Veli Han';	
	
--calisanlar tablosundan maasi 5 bin olan tum verileri listeleyiniz
...
--aaadresler tablosundan sehri Antep olan verileri silelim
